    ...
    return (
        <nav className="h-20 flex border-b justify-between font-medium bg-white">
            ...
            <div className="hidden lg:flex">
                <Button variant="secondary" className="border-l border-t-o border-b-o border-r-0 px-12 h-full rounded-none bg-white hover:bg-pink-400 transition-colors text-lg">
                    <Link href="/sign-in">
                        Log In
                    </Link>
                </Button>
                <Button variant="secondary" className="border-l border-t-o border-b-o border-r-0 px-12 h-full rounded-none bg-black text-white hover:bg-pink-400 hover:text-black transition-colors text-lg">
                    <Link href="/sign-up">
                        Start Selling
                    </Link>
                </Button>
